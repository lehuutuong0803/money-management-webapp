...
const AddIncomeAndExpenseForm = ({onAddIncome, categories, isIncome}) => {
    ...
    return(
        <div>
            ...
            <Input 
                ...
                label={isIncome ? "Income Source" : "Expense Source"}
                placeholder={isIncome ? "e.g., Salary, Freelance, Bonus" : "e.g., Shopping, Rent"}
                type="text"
            />
